...
class StatsEntry(object):
    ...
    def extend(self, other, full_request_history=False):
        ...
        self.min_response_time = min(self.min_response_time, other.min_response_time) or other.min_response_time if other.min_response_time else self.min_response_time
